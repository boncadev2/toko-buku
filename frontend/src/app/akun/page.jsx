...
export default function AccountPage() {
  ...
  useEffect(() => {
    ...
    api("/settings").then(r => ((d) => { localStorage.setItem("app_settings", JSON.stringify(typeof d === "function" ? d(settings) : d)); setSettings(d); })(r.data||{})).catch(()=>null);
