...
export default function AccountPage() {
  ...
  return <main className="min-h-screen bg-[#f4f8ff] text-slate-800">
    ...
    <div className="mx-auto grid max-w-7xl gap-6 px-5 py-7 lg:grid-cols-[235px_1fr]">
      ...
      <section className="min-w-0"><div className="overflow-hidden rounded-3xl bg-gradient-to-br from-blue-800 via-blue-700 to-cyan-600 p-7 text-white shadow-xl shadow-blue-800/20"><p className="text-sm font-semibold text-blue-100">Selamat datang kembali,</p><h1 className="mt-1 text-3xl font-black sm:text-4xl">Halo, {firstName}! 👋</h1><p className="mt-3 max-w-xl text-sm leading-6 text-blue-100">Kelola pesanan dan informasi akun Anda dari satu tempat.</p><a href="/cari" className="mt-6 inline-flex rounded-xl bg-white px-4 py-2.5 text-sm font-bold text-blue-800 shadow">Cari buku favorit</a></div>
...
function AccountNav() {
  return <nav className="space-y-1"><a href="/akun" className="flex items-center gap-3 rounded-xl bg-white/15 px-3 py-3 text-sm font-bold">▦ Dashboard</a><a href="/akun/profil" className="flex items-center gap-3 rounded-xl px-3 py-3 text-sm text-blue-100 hover:bg-white/10">👤 Profil</a><a href="/akun/pesanan" className="flex items-center gap-3 rounded-xl px-3 py-3 text-sm text-blue-100 hover:bg-white/10">▣ Pesanan saya</a><a href="/" className="flex items-center gap-3 rounded-xl px-3 py-3 text-sm text-blue-100 hover:bg-white/10">⌂ Kembali berbelanja</a></nav>;
}
