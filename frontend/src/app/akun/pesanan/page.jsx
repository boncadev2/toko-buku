...
export default function OrdersPage() {
  ...
  return <main className="flex min-h-screen flex-col bg-[#f4f8ff] text-slate-800">
    <header className="border-b border-blue-100 bg-white"><div className="mx-auto flex w-full max-w-7xl items-center justify-between px-5 py-4"><a href="/" className="font-black text-blue-950">📚 BukuPagi</a><a href="/akun" className="text-sm font-bold text-blue-700">← Dashboard</a></div></header>
...
function Sidebar(){return <aside className="h-[280px] self-start rounded-3xl bg-gradient-to-b from-blue-950 to-blue-800 p-4 text-white shadow-xl"><p className="px-3 pb-3 text-[11px] font-bold uppercase tracking-[.18em] text-blue-300">Menu akun</p><nav className="space-y-1"><a href="/akun" className="block rounded-xl px-3 py-3 text-sm text-blue-100">▦ Dashboard</a><a href="/akun/profil" className="block rounded-xl px-3 py-3 text-sm text-blue-100">👤 Profil</a><a href="/akun/pesanan" className="block rounded-xl bg-white/15 px-3 py-3 text-sm font-bold">▣ Pesanan saya</a><a href="/" className="block rounded-xl px-3 py-3 text-sm text-blue-100">⌂ Kembali berbelanja</a></nav></aside>}
